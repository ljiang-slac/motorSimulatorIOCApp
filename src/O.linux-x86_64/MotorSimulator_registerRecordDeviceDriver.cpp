...
/* Generated from ../O.Common/MotorSimulator.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_motorRegister, pvar_func_motorSimRegister,
...
int MotorSimulator_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/app/MotorSimulatorApp";
...
/* MotorSimulator_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: MotorSimulator_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(MotorSimulator_registerRecordDeviceDriver(*iocshPpdbbase));
}
